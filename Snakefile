...
rule all:
    input: BT1=bt1_index_files('BT1_index_hg38.analysisSet', 'index', large=True),
           ...
           salmon_kg=salmon_index_files('Salmon_index_hg38.analysisSet_knownGene', perfectHash=True),
           salmon_genemap_kg='Salmon_index_hg38.analysisSet_knownGene/genemap.txt',
           kallisto_kg='Kallisto_index_hg38.analysisSet_knownGene',
           ...
           salmon_ens85=salmon_index_files('Salmon_index_hg38.analysisSet_ensembl.85', perfectHash=True),
           salmon_genemap_ens85='Salmon_index_hg38.analysisSet_ensembl.85/genemap.txt',
           kallisto_ens85='Kallisto_index_hg38.analysisSet_ensembl.85',
